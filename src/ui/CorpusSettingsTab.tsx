...
import { View, Text, StyleSheet, FlatList, Pressable, TextInput, Switch, Alert, ActivityIndicator } from "react-native";
 ...
 * user-imported document collections — pick files, chunk + embed them
 * on-device, and manage the result as a named, toggleable, exportable unit.
 */
